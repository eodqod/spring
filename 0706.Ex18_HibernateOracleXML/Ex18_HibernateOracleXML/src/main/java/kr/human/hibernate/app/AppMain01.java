...
public class AppMain01 {
	public static void main(String[] args) {
		...
		Student student2 = StudentServiceImpl.getInstance().selectById(5);
		System.out.println("수정 전 : " + student2);
		student2.setSection("백앤드개발자");
		StudentServiceImpl.getInstance().update(student2);
		student2 = StudentServiceImpl.getInstance().selectById(5);
		System.out.println("수정 후 : " + student2);
		
		StudentServiceImpl.getInstance().delete(6);
