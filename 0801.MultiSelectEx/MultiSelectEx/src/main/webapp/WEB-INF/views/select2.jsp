...
<script type="text/javascript">
	$(function(){
		...
		$("#getResult").click(function(){
			...
			var address=data1 + " " + data2 + " " + data3;
			//alert(address);
			var address = encodeURI(address);
			var t = 'https://8oi9s0nnth.apigw.ntruss.com/corona19-masks/v1/storesByAddr/json?address=' + address;
			
			$.ajax('https://8oi9s0nnth.apigw.ntruss.com/corona19-masks/v1/storesByAddr/json?address=' + address, {
				type:'GET',
				dataType:'json',
				error : function(){
					alert('실패!!!');
